...
Variable::Variable(Tensor data, bool requires_grad, std::shared_ptr<Node> grad_fn) {
    throw std::logic_error("Variable::Variable pas encore implemente");
}
...
void Variable::zero_grad() {
    throw std::logic_error("Variable::zero_grad pas encore implemente");
}
...
void Variable::accumulate_grad(const Tensor& delta) {
    throw std::logic_error("Variable::accumulate_grad pas encore implemente");
}
...
void Variable::build_topo(std::vector<Variable>& topo, std::unordered_set<const void*>& visited) const {
    throw std::logic_error("Variable::build_topo pas encore implemente");
}
...
void Variable::backward() {
    throw std::logic_error("Variable::backward pas encore implemente");
}
...
Variable Variable::operator+(const Variable& other) const {
    throw std::logic_error("Variable::operator+ pas encore implemente");
}
